package com.redefocus.factionscaribe.mcmmo.skills.salvage.salvageables;
...
public interface Salvageable {
    ...
    /**
     * Gets the metadata byte value of the items dropped when salvaging this
     * item
     *
    ...
    /**
     * Gets the maximum quantity of salvage materials ignoring all other salvage
     * bonuses
     *
     * This is typically set to the number of items needed to create that item,
     * for example 5 for helmets or 2 for swords
     *
