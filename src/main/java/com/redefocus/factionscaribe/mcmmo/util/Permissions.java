...
import com.redefocus.factionscaribe.mcmmo.datatypes.skills.ItemType;
import com.redefocus.factionscaribe.mcmmo.datatypes.skills.MaterialType;
...
public final class Permissions {
    ...
    public static boolean mctop(Permissible permissible, SkillType skill) {
        return skill.isActive() && permissible.hasPermission("mcmmo.commands.mctop." + skill.toString().toLowerCase());
    }
    ...
    public static boolean skillreset(Permissible permissible, SkillType skill) {
        return skill.isActive() && permissible.hasPermission("mcmmo.commands.skillreset." + skill.toString().toLowerCase());
    }
    ...
    public static boolean skillresetOthers(Permissible permissible, SkillType skill) {
        return skill.isActive() && permissible.hasPermission("mcmmo.commands.skillreset.others." + skill.toString().toLowerCase());
    }

    public static boolean xplock(Permissible permissible, SkillType skill) {
        return skill.isActive() && permissible.hasPermission("mcmmo.commands.xplock." + skill.toString().toLowerCase());
    }
    ...
    public static boolean lucky(Permissible permissible, SkillType skill) {
        return skill.isActive() && permissible.hasPermission("mcmmo.perks.lucky." + skill.toString().toLowerCase());
    }

    /* XP PERKS */
    public static boolean quadrupleXp(Permissible permissible, SkillType skill) {
        return skill.isActive() && permissible.hasPermission("mcmmo.perks.xp.quadruple." + skill.toString().toLowerCase());
    }

    public static boolean tripleXp(Permissible permissible, SkillType skill) {
        return skill.isActive() && permissible.hasPermission("mcmmo.perks.xp.triple." + skill.toString().toLowerCase());
    }

    public static boolean doubleAndOneHalfXp(Permissible permissible, SkillType skill) {
        return skill.isActive() && permissible.hasPermission("mcmmo.perks.xp.150percentboost." + skill.toString().toLowerCase());
    }

    public static boolean doubleXp(Permissible permissible, SkillType skill) {
        return skill.isActive() && permissible.hasPermission("mcmmo.perks.xp.double." + skill.toString().toLowerCase());
    }

    public static boolean oneAndOneHalfXp(Permissible permissible, SkillType skill) {
        return skill.isActive() && permissible.hasPermission("mcmmo.perks.xp.50percentboost." + skill.toString().toLowerCase());
    }

    public static boolean oneAndOneTenthXp(Permissible permissible, SkillType skill) {
        return skill.isActive() && permissible.hasPermission("mcmmo.perks.xp.10percentboost." + skill.toString().toLowerCase());
    }

    public static boolean customXpBoost(Permissible permissible, SkillType skill) {
        return skill.isActive() && permissible.hasPermission("mcmmo.perks.xp.customboost." + skill.toString().toLowerCase());
    }
    ...
    public static boolean skillEnabled(Permissible permissible, SkillType skill) {
        return skill.isActive();// && permissible.hasPermission("mcmmo.skills." + skill.toString().toLowerCase());
    }

    public static boolean vanillaXpBoost(Permissible permissible, SkillType skill) {
        return skill.isActive() && permissible.hasPermission("mcmmo.ability." + skill.toString().toLowerCase() + ".vanillaxpboost");
    }

    public static boolean secondaryAbilityEnabled(Permissible permissible, SecondaryAbility skillAbility) {
        return skillAbility.isActive();// && permissible.hasPermission("mcmmo.ability." + SkillType.bySecondaryAbility(skillAbility).toString().toLowerCase() + "." + StringUtils.getPrettySecondaryAbilityString(skillAbility).replace(" ", "").toLowerCase());
    }

    public static boolean bonusDamage(Permissible permissible, SkillType skill) {
        return skill.isActive() && permissible.hasPermission("mcmmo.ability." + skill.toString().toLowerCase() + ".bonusdamage");
    }
    ...
    public static void generateWorldTeleportPermissions() {
        Server server = FactionsCaribe.getInstance().getServer();
