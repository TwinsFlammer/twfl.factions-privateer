...
public final class CommandUtils {
     ...
     *
     * @return true if the player is online and a valid mcMMOPlayer object was
     * found
     */
    ...
    public static List<String> getOnlinePlayerNames(CommandSender sender) {
        ...
        for (Player onlinePlayer : FactionsCaribe.getInstance().getServer().getOnlinePlayers()) {
    ...
    public static String getMatchedPlayerName(String partialName) {
        if (Config.getInstance().getMatchOfflinePlayers()) {
            ...
            Player player = FactionsCaribe.getInstance().getServer().getPlayer(partialName);
    ...
    /**
     * Attempts to match any player names with the given name, and returns a
     * list of all possibly matches.
     *
    ...
    private static List<String> matchPlayer(String partialName) {
        ...
        for (OfflinePlayer offlinePlayer : FactionsCaribe.getInstance().getServer().getOfflinePlayers()) {
