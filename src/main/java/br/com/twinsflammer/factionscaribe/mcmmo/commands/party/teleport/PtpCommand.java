package br.com.twinsflammer.factionscaribe.mcmmo.commands.party.teleport;
...
import br.com.twinsflammer.factionscaribe.mcmmo.runnables.items.TeleportationWarmup;
...
public class PtpCommand implements TabExecutor {
    ...
    protected static void handleTeleportWarmup(Player teleportingPlayer, Player targetPlayer) {
        ...
        if (warmup > 0) {
            ...
            new TeleportationWarmup(mcMMOPlayer, mcMMOTarget).runTaskLater(FactionsCaribe.getInstance(), 20 * warmup);
        } else {
