...
import br.com.twinsflammer.factionscaribe.mcmmo.skills.repair.repairables.RepairableFactory;
    ...
    private void loadTool(String toolType, List<Material> materialList) {
        ...
        for (String toolName : toolConfigSet) {
            ...
            if (toolMaterial == null) {
                FactionsCaribe.getInstance().getLogger().warning("Invalid material name. This item will be skipped. - " + toolName);
                continue;
            }
            ...
            if (repairable && (repairMaterial == null)) {
                FactionsCaribe.getInstance().getLogger().warning("Incomplete repair information. This item will be unrepairable. - " + toolName);
                repairable = false;
            }
