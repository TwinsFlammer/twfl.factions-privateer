package br.com.twinsflammer.factionscaribe.mcmmo.skills.mining;
...
import br.com.twinsflammer.factionscaribe.mcmmo.runnables.skills.AbilityCooldownTask;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.SkillManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.mining.BlastMining.Tier;
...
public class MiningManager extends SkillManager {
    ...
    public void remoteDetonation() {
        ...
        new AbilityCooldownTask(mcMMOPlayer, AbilityType.BLAST_MINING).runTaskLaterAsynchronously(FactionsCaribe.getInstance(), AbilityType.BLAST_MINING.getCooldown() * Misc.TICK_CONVERSION_FACTOR);
    }
