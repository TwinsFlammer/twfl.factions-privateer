package br.com.twinsflammer.factionscaribe.mcmmo.runnables.backups;
...
public class CleanBackupsTask extends BukkitRunnable {
    ...
    public void run() {
        ...
        FactionsCaribe.getInstance().getServer().getLogger().info("Cleaned backup files. Deleted " + amountDeleted + " of " + amountTotal + " files.");
