...
import br.com.twinsflammer.factionscaribe.mcmmo.commands.skills.AprilCommand;
...
public final class HolidayManager {
    ...
    public HolidayManager() {
        ...
        if (!anniversaryFile.exists()) {
            try {
                ...
                FactionsCaribe.getInstance().getLogger().severe(ex.toString());
            }
        }
 ...
 /*
    ...
    public void registerAprilCommand() {
        PluginCommand command = FactionsCaribe.getInstance().getCommand("mcfools");
