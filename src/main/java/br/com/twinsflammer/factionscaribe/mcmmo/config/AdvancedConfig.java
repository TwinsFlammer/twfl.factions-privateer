package br.com.twinsflammer.factionscaribe.mcmmo.config;
...
import br.com.twinsflammer.factionscaribe.mcmmo.skills.repair.ArcaneForging;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.salvage.Salvage;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.smelting.Smelting;
...
public class AdvancedConfig extends AutoUpdateConfigLoader {
    ...
    public double getMaxChance(SecondaryAbility skillAbility) {
        if (skillAbility == null || SkillType.bySecondaryAbility(skillAbility) == null || !skillAbility.isActive()) {
            return 0D;
        }
