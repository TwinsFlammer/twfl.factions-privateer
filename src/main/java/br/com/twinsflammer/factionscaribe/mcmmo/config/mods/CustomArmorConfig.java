    ...
    private void loadArmor(String armorType, List<Material> materialList) {
        ...
        for (String armorName : armorConfigSet) {
            ...
            if (armorMaterial == null) {
                FactionsCaribe.getInstance().getLogger().warning("Invalid material name. This item will be skipped. - " + armorName);
                continue;
            }
            ...
            if (repairable && (repairMaterial == null)) {
                FactionsCaribe.getInstance().getLogger().warning("Incomplete repair information. This item will be unrepairable. - " + armorName);
                repairable = false;
            }
