...
import br.com.twinsflammer.factionscaribe.mcmmo.config.mods.CustomArmorConfig;
import br.com.twinsflammer.factionscaribe.mcmmo.config.mods.CustomBlockConfig;
import br.com.twinsflammer.factionscaribe.mcmmo.config.mods.CustomEntityConfig;
import br.com.twinsflammer.factionscaribe.mcmmo.config.mods.CustomToolConfig;
...
import br.com.twinsflammer.factionscaribe.mcmmo.datatypes.mods.CustomEntity;
...
public class ModManager {
    ...
    public void addCustomEntity(Entity entity) {
        ...
        File entityFile = new File(FactionsCaribe.getInstance().getDataFolder(), "mods" + File.separator + "entities.default.yml");
