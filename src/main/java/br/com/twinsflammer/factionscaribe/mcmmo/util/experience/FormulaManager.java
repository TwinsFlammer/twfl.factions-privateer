package br.com.twinsflammer.factionscaribe.mcmmo.util.experience;
...
public class FormulaManager {
    ...
    /**
     * Calculate the total amount of experience earned based on the amount of
     * levels and experience, using the previously used formula type.
     *
    ...
    /**
     * Calculate how many levels a player should have using the new formula
     * type.
     *
    ...
    /**
     * Get the cached amount of experience needed to reach the next level, if
     * cache doesn't contain the given value it is calculated and added to the
     * cached data.
     *
