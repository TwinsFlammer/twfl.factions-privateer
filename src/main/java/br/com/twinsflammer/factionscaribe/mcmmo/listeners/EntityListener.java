package br.com.twinsflammer.factionscaribe.mcmmo.listeners;
...
import br.com.twinsflammer.factionscaribe.mcmmo.events.fake.FakeEntityDamageByEntityEvent;
import br.com.twinsflammer.factionscaribe.mcmmo.events.fake.FakeEntityDamageEvent;
import br.com.twinsflammer.factionscaribe.mcmmo.events.fake.FakeEntityTameEvent;
...
import br.com.twinsflammer.factionscaribe.mcmmo.skills.archery.Archery;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.fishing.Fishing;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.herbalism.Herbalism;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.mining.BlastMining;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.mining.MiningManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.taming.Taming;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.taming.TamingManager;
import br.com.twinsflammer.factionscaribe.mcmmo.util.BlockUtils;
...
public class EntityListener implements Listener {
    ...
    public void onEntityShootBow(EntityShootBowEvent event) {
        ...
        projectile.setMetadata(mcMMO.bowForceKey, new FixedMetadataValue(FactionsCaribe.getInstance(), Math.min(event.getForce() * AdvancedConfig.getInstance().getForceMultiplier(), 1.0)));
        projectile.setMetadata(mcMMO.arrowDistanceKey, new FixedMetadataValue(FactionsCaribe.getInstance(), projectile.getLocation()));
    }
    ...
    public void onProjectileLaunch(ProjectileLaunchEvent event) {
        ...
        projectile.setMetadata(mcMMO.bowForceKey, new FixedMetadataValue(FactionsCaribe.getInstance(), 1.0));
        projectile.setMetadata(mcMMO.arrowDistanceKey, new FixedMetadataValue(FactionsCaribe.getInstance(), projectile.getLocation()));
    }
    ...
    public void onEntityDamageByEntity(EntityDamageByEntityEvent event) {
        ...
        if (defender.hasMetadata(mcMMO.customDamageKey)) {
            defender.removeMetadata(mcMMO.customDamageKey, FactionsCaribe.getInstance());
            return;
        }
    ...
    public void onEntityDamage(EntityDamageEvent event) {
        ...
        if (entity.hasMetadata(mcMMO.customDamageKey)) {
            entity.removeMetadata(mcMMO.customDamageKey, FactionsCaribe.getInstance());
            return;
        }
    ...
    public void onEntityDeathLowest(EntityDeathEvent event) {
        ...
        if (entity.hasMetadata(mcMMO.customNameKey)) {
            ...
            entity.removeMetadata(mcMMO.customNameKey, FactionsCaribe.getInstance());
        }
        ...
        if (entity.hasMetadata(mcMMO.customVisibleKey)) {
            ...
            entity.removeMetadata(mcMMO.customVisibleKey, FactionsCaribe.getInstance());
        }
    }
    ...
    public void onExplosionPrime(ExplosionPrimeEvent event) {
        ...
        Player player = FactionsCaribe.getInstance().getServer().getPlayerExact(entity.getMetadata(mcMMO.tntMetadataKey).get(0).asString());
