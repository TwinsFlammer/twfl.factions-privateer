...
import br.com.twinsflammer.factionscaribe.mcmmo.config.party.ItemWeightConfig;
...
public final class ItemUtils {
    ...
    public static boolean isSmelted(ItemStack item) {
        ...
        for (Recipe recipe : FactionsCaribe.getInstance().getServer().getRecipesFor(item)) {
    ...
    /**
     * Checks to see if an item is a miscellaneous drop. These items are read
