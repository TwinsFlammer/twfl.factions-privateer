...
import br.com.twinsflammer.factionscaribe.mcmmo.datatypes.experience.SkillXpGain;
...
public class PlayerProfile {
    ...
    public PlayerProfile(String playerName, UUID uuid) {
        ...
        mobHealthbarType = MobHealthbarType.DISABLED;// Config.getInstance().getMobHealthbarDefault();
    ...
    public PlayerProfile(String playerName, UUID uuid, Map<SkillType, Integer> levelData, Map<SkillType, Float> xpData, Map<AbilityType, Integer> cooldownData, MobHealthbarType mobHealthbarType, int scoreboardTipsShown) {
        this.playerName = playerName;
        this.uuid = uuid;
        this.mobHealthbarType = MobHealthbarType.DISABLED;//mobHealthbarType;
    ...
    public void scheduleAsyncSave() {
        new PlayerProfileSaveTask(this).runTaskAsynchronously(FactionsCaribe.getInstance());
    }
    ...
    public void save() {
        ...
        if (changed) {
            FactionsCaribe.getInstance().getLogger().warning("PlayerProfile saving failed for player: " + playerName + " " + uuid);
        }
    }
    ...
    public MobHealthbarType getMobHealthbarType() {
        return MobHealthbarType.DISABLED;//mobHealthbarType;
    }
    ...
    /**
     * Get the registered amount of experience gained This is used for
     * diminished XP returns
     *
    ...
    /**
     * Remove experience gains older than a given time This is used for
     * diminished XP returns
     */
