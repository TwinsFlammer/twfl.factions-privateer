package br.com.twinsflammer.factionscaribe.mcmmo.util.upgrade;
...
public class UpgradeManager extends ConfigLoader {
    ...
    /**
     * Set the given {@link UpgradeType} as completed. Does nothing if the
     * upgrade was applied previously.
     *
