...
import br.com.twinsflammer.factionscaribe.mcmmo.chat.ChatManager;
import br.com.twinsflammer.factionscaribe.mcmmo.chat.ChatManagerFactory;
...
import br.com.twinsflammer.factionscaribe.mcmmo.skills.repair.Repair;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.repair.RepairManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.salvage.Salvage;
...
import br.com.twinsflammer.factionscaribe.mcmmo.skills.unarmed.Unarmed;
...
import br.com.twinsflammer.factionscaribe.mcmmo.util.ChimaeraWing;
import br.com.twinsflammer.factionscaribe.mcmmo.util.EventUtils;
import br.com.twinsflammer.factionscaribe.mcmmo.util.HardcoreManager;
import br.com.twinsflammer.factionscaribe.mcmmo.util.ItemUtils;
import br.com.twinsflammer.factionscaribe.mcmmo.util.Misc;
import br.com.twinsflammer.factionscaribe.mcmmo.util.MobHealthbarUtils;
import br.com.twinsflammer.factionscaribe.mcmmo.util.Motd;
...
public class PlayerListener implements Listener {
    ...
    public void onPlayerChat(AsyncPlayerChatEvent event) {
        ...
        if (mcMMOPlayer.isChatEnabled(ChatMode.PARTY)) {
            ...
            chatManager = ChatManagerFactory.getChatManager(FactionsCaribe.getInstance(), ChatMode.PARTY);
            ((PartyChatManager) chatManager).setParty(party);
        } else if (mcMMOPlayer.isChatEnabled(ChatMode.ADMIN)) {
            chatManager = ChatManagerFactory.getChatManager(FactionsCaribe.getInstance(), ChatMode.ADMIN);
        }
