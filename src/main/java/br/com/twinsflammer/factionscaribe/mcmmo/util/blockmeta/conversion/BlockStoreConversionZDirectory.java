package br.com.twinsflammer.factionscaribe.mcmmo.util.blockmeta.conversion;

import br.com.twinsflammer.factionscaribe.mcmmo.mcMMO;
import br.com.twinsflammer.factionscaribe.mcmmo.util.blockmeta.ChunkletStore;
import br.com.twinsflammer.factionscaribe.mcmmo.util.blockmeta.HashChunkletManager;
import br.com.twinsflammer.factionscaribe.mcmmo.util.blockmeta.PrimitiveChunkletStore;
import br.com.twinsflammer.factionscaribe.mcmmo.util.blockmeta.PrimitiveExChunkletStore;
import br.com.twinsflammer.factionscaribe.mcmmo.util.blockmeta.chunkmeta.HashChunkManager;
import br.com.twinsflammer.factionscaribe.mcmmo.util.blockmeta.chunkmeta.PrimitiveChunkStore;
import java.io.File;
...
public class BlockStoreConversionZDirectory implements Runnable {
    ...
    public void start(org.bukkit.World world, File xDir, File dataDir) {
        this.world = world;
        this.scheduler = FactionsCaribe.getInstance().getServer().getScheduler();
        ...
        this.taskID = this.scheduler.runTaskLater(FactionsCaribe.getInstance(), this, 1).getTaskId();
        return;
    }
