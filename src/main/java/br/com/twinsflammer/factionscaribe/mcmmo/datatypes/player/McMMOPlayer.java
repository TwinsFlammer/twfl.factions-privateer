package br.com.twinsflammer.factionscaribe.mcmmo.datatypes.player;
...
import br.com.twinsflammer.factionscaribe.mcmmo.party.ShareHandler;
import br.com.twinsflammer.factionscaribe.mcmmo.runnables.skills.AbilityDisableTask;
import br.com.twinsflammer.factionscaribe.mcmmo.runnables.skills.BleedTimerTask;
import br.com.twinsflammer.factionscaribe.mcmmo.runnables.skills.ToolLowerTask;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.SkillManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.acrobatics.AcrobaticsManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.alchemy.AlchemyManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.archery.ArcheryManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.axes.AxesManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.child.FamilyTree;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.excavation.ExcavationManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.fishing.FishingManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.herbalism.HerbalismManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.mining.MiningManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.repair.RepairManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.salvage.SalvageManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.smelting.SmeltingManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.swords.SwordsManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.taming.TamingManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.unarmed.UnarmedManager;
import br.com.twinsflammer.factionscaribe.mcmmo.skills.woodcutting.WoodcuttingManager;
...
import br.com.twinsflammer.factionscaribe.mcmmo.datatypes.mods.CustomTool;
import br.com.twinsflammer.factionscaribe.mcmmo.datatypes.party.Party;
import br.com.twinsflammer.factionscaribe.mcmmo.datatypes.party.PartyTeleportRecord;
...
public class McMMOPlayer {
    ...
    public McMMOPlayer(Player player, PlayerProfile profile) {
        ...
        this.player = player;
        playerMetadata = new FixedMetadataValue(FactionsCaribe.getInstance(), playerName);
        ...
        try {
            ...
            e.printStackTrace();
            FactionsCaribe.getInstance().getPluginLoader().disablePlugin(FactionsCaribe.getInstance());
        }
    ...
    public void checkAbilityActivation(SkillType skill) {
        ...
        new AbilityDisableTask(this, ability).runTaskLater(FactionsCaribe.getInstance(), ticks * Misc.TICK_CONVERSION_FACTOR);
    }
    ...
    public void processAbilityActivation(SkillType skill) {
        ...
        if (ability.getPermissions(player) && tool.inHand(inHand) && !getToolPreparationMode(tool)) {
            ...
            new ToolLowerTask(this, tool).runTaskLaterAsynchronously(FactionsCaribe.getInstance(), 4 * Misc.TICK_CONVERSION_FACTOR);
        }
    }
