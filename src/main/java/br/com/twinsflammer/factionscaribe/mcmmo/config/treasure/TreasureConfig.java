package br.com.twinsflammer.factionscaribe.mcmmo.config.treasure;

import br.com.twinsflammer.factionscaribe.mcmmo.config.ConfigLoader;
...
import br.com.twinsflammer.factionscaribe.mcmmo.util.EnchantmentUtils;
    ...
    private void loadEnchantments() {
        for (Rarity rarity : Rarity.values()) {
            ...
            for (String enchantmentName : enchantmentSection.getKeys(false)) {
                ...
                if (enchantment == null) {
                    FactionsCaribe.getInstance().getLogger().warning("Skipping invalid enchantment in treasures.yml: " + enchantmentName);
                    continue;
                }
