package br.com.twinsflammer.factionscaribe.mcmmo.skills.woodcutting;
...
public final class Woodcutting {
     ...
     * list of blocks used for future recursive calls of 'processTree()'
     *
     * @param blockState Block to be added
     * @param futureCenterBlocks List of blocks that will be used to call
     * 'processTree()'
     * @param treeFellerBlocks List of blocks to be removed
     * @return true if and only if the given blockState was a Log not already in
     * treeFellerBlocks.
     */
