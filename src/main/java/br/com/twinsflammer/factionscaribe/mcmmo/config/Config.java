...
import br.com.twinsflammer.factionscaribe.mcmmo.database.SQLDatabaseManager;
...
public class Config extends AutoUpdateConfigLoader {
    ...
    public int getSaveInterval() {
        return 1;// config.getInt("General.Save_Interval", 1);
    }
    ...
    public boolean getChimaeraEnabled() {
        return config.getBoolean("Items.Chimaera_Wing.Enabled", false);
    }
    ...
    public boolean getChimaeraSoundEnabled() {
        return config.getBoolean("Items.Chimaera_Wing.Sound_Enabled", false);
    }

    public boolean getFluxPickaxeEnabled() {
        return config.getBoolean("Items.Flux_Pickaxe.Enabled", false);
    }

    public boolean getFluxPickaxeSoundEnabled() {
        return config.getBoolean("Items.Flux_Pickaxe.Sound_Enabled", false);
    }
