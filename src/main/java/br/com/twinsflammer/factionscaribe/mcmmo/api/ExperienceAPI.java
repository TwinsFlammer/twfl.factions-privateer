...
import br.com.twinsflammer.factionscaribe.mcmmo.api.exceptions.InvalidFormulaTypeException;
import br.com.twinsflammer.factionscaribe.mcmmo.api.exceptions.InvalidPlayerException;
import br.com.twinsflammer.factionscaribe.mcmmo.api.exceptions.InvalidSkillException;
import br.com.twinsflammer.factionscaribe.mcmmo.api.exceptions.InvalidXPGainReasonException;
...
import br.com.twinsflammer.factionscaribe.mcmmo.api.exceptions.McMMOPlayerNotFoundException;
...
public final class ExperienceAPI {
    ...
    /**
     * Returns whether the given skill type string is both valid and not a child
    ...
    private static PlayerProfile getOfflineProfile(String playerName) {
        UUID uuid = FactionsCaribe.getInstance().getServer().getOfflinePlayer(playerName).getUniqueId();
        PlayerProfile profile = mcMMO.getDatabaseManager().loadPlayerProfile(uuid);
