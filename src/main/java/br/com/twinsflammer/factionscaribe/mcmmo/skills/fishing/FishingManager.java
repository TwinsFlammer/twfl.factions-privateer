package br.com.twinsflammer.factionscaribe.mcmmo.skills.fishing;
...
import br.com.twinsflammer.factionscaribe.mcmmo.datatypes.treasure.EnchantmentTreasure;
import br.com.twinsflammer.factionscaribe.mcmmo.datatypes.treasure.FishingTreasure;
import br.com.twinsflammer.factionscaribe.mcmmo.datatypes.treasure.Rarity;
import br.com.twinsflammer.factionscaribe.mcmmo.datatypes.treasure.ShakeTreasure;
import br.com.twinsflammer.factionscaribe.mcmmo.events.skills.fishing.McMMOPlayerFishingTreasureEvent;
import br.com.twinsflammer.factionscaribe.mcmmo.events.skills.fishing.McMMOPlayerShakeEvent;
import br.com.twinsflammer.factionscaribe.mcmmo.events.skills.secondaryabilities.SecondaryAbilityWeightedActivationCheckEvent;
import br.com.twinsflammer.factionscaribe.mcmmo.locale.LocaleLoader;
import br.com.twinsflammer.factionscaribe.mcmmo.mcMMO;
import br.com.twinsflammer.factionscaribe.mcmmo.runnables.skills.KrakenAttackTask;
...
public class FishingManager extends SkillManager {
    ...
    public boolean canShake(Entity target) {
        return target instanceof LivingEntity && getSkillLevel() >= Fishing.Tier.ONE.getLevel() && Permissions.secondaryAbilityEnabled(getPlayer(), SecondaryAbility.SHAKE);
    }
    ...
    private boolean unleashTheKraken(boolean forceSpawn) {
        ...
        if (globalEffectsEnabled) {
            ...
            FactionsCaribe.getInstance().getServer().broadcastMessage(ChatColor.RED + AdvancedConfig.getInstance().getServerUnleashMessage().replace("(PLAYER)", player.getDisplayName()));
        } else {
        ...
        if (!kraken.isValid()) {
            ...
            new KrakenAttackTask(kraken, player, player.getLocation()).runTaskTimer(FactionsCaribe.getInstance(), attackInterval, attackInterval);
        ...
        int attackInterval = AdvancedConfig.getInstance().getKrakenAttackInterval() * Misc.TICK_CONVERSION_FACTOR;
        new KrakenAttackTask(kraken, player).runTaskTimer(FactionsCaribe.getInstance(), attackInterval, attackInterval);
    ...
    public void shakeCheck(LivingEntity target) {
        ...
        FactionsCaribe.getInstance().getServer().getPluginManager().callEvent(activationEvent);
