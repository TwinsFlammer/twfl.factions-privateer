        ...
        switch (args.length) {
            case 1:
                ...
                if (mcMMO.p.isXPEventEnabled()) {
                    FactionsCaribe.getInstance().getServer().broadcastMessage(LocaleLoader.getString("Commands.xprate.over"));
            ...
            case 2:
                ...
                if (mcMMO.p.isXPEventEnabled()) {
                    FactionsCaribe.getInstance().getServer().broadcastMessage(LocaleLoader.getString("Commands.xprate.started.0"));
                    FactionsCaribe.getInstance().getServer().broadcastMessage(LocaleLoader.getString("Commands.xprate.started.1", newXpRate));
                } else {
