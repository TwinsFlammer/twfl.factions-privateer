...
public interface ChunkStore extends Serializable {
     ...
     * @return true if the value is true at the given coordinates, false if
     * otherwise
     */
    ...
    /**
     * Set all values in this ChunkletStore to the values from another provided
     * ChunkletStore
     *
     * @param otherStore Another ChunkletStore that this one should copy all
     * data from
     */
