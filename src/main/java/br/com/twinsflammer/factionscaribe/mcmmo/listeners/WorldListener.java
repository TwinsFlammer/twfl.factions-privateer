...
import br.com.twinsflammer.factionscaribe.mcmmo.util.blockmeta.conversion.BlockStoreConversionMain;
...
public class WorldListener implements Listener {
    ...
    public void onWorldInit(WorldInitEvent event) {
        ...
        FactionsCaribe.getInstance().getLogger().info("Converting block storage for " + world.getName() + " to a new format.");
