...
public class PotionConfig extends ConfigLoader {
    ...
    private AlchemyPotion loadPotion(ConfigurationSection potion_section) {
        try {
            ...
            if (potion_section.contains("Effects")) {
                for (String effect : potion_section.getStringList("Effects")) {
                    ...
                    if (type != null) {
                        ...
                        FactionsPrivateer.getInstance().getLogger().warning("Failed to parse effect for potion " + name + ": " + effect);
                    }
                }
            }
            ...
            if (potion_section.contains("Children")) {
                for (String child : potion_section.getConfigurationSection("Children").getKeys(false)) {
                    ...
                    if (ingredient != null) {
                        ...
                        FactionsPrivateer.getInstance().getLogger().warning("Failed to parse child for potion " + name + ": " + child);
                    }
                }
            }
            ...
            FactionsPrivateer.getInstance().getLogger().warning("Failed to load Alchemy potion: " + potion_section.getName());
            return null;
        }
    }
