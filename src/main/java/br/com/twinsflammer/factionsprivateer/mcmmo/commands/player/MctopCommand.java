...
import br.com.twinsflammer.factionsprivateer.mcmmo.runnables.commands.MctopCommandAsyncTask;
...
public class MctopCommand implements TabExecutor {
    ...
    private void display(int page, SkillType skill, CommandSender sender) {
        ...
        new MctopCommandAsyncTask(page, skill, sender, useBoard, useChat).runTaskAsynchronously(FactionsPrivateer.getInstance());
    }
