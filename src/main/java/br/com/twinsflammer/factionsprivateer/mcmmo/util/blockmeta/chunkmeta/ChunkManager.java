...
public interface ChunkManager {
    ...
    /**
     * Unload all ChunkletStores from memory related to the given world after
     * saving them
     *
    ...
    /**
     * Load all ChunkletStores from all loaded chunks from this world into
     * memory
     *
     ...
     * @return true if the given block location is set to true, false if
     * otherwise
     */
     ...
     * @return true if the given BlockState location is set to true, false if
     * otherwise
     */
    public boolean isTrue(BlockState blockState);

    /**
     * Set a given location to true, should create stores as necessary if the
    ...
    /**
     * Set a given block location to true, should create stores as necessary if
    ...
    /**
     * Set a given BlockState location to true, should create stores as
     * necessary if the location does not exist
     *
    ...
    /**
     * Set a given location to false, should not create stores if one does not
     * exist for the given location
     *
     * @param x X coordinate to set
     * @param y Y coordinate to set
     * @param z Z coordinate to set
    ...
    /**
     * Set a given block location to false, should not create stores if one does
     * not exist for the given location
     *
     * @param block Block location to set
     */
    ...
    /**
     * Set a given BlockState location to false, should not create stores if one
     * does not exist for the given location
     *
     * @param blockState BlockState location to set
     */
