...
import br.com.twinsflammer.factionsprivateer.mcmmo.runnables.items.TeleportationWarmup;
...
public class PtpCommand implements TabExecutor {
    ...
    protected static void handleTeleportWarmup(Player teleportingPlayer, Player targetPlayer) {
        ...
        if (warmup > 0) {
            ...
            new TeleportationWarmup(mcMMOPlayer, mcMMOTarget).runTaskLater(FactionsPrivateer.getInstance(), 20 * warmup);
        } else {
