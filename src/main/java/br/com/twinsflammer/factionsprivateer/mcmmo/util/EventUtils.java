...
import br.com.twinsflammer.factionsprivateer.mcmmo.events.fake.FakePlayerAnimationEvent;
import br.com.twinsflammer.factionsprivateer.mcmmo.events.fake.FakePlayerFishEvent;
import br.com.twinsflammer.factionsprivateer.mcmmo.events.hardcore.McMMOPlayerPreDeathPenaltyEvent;
import br.com.twinsflammer.factionsprivateer.mcmmo.events.hardcore.McMMOPlayerStatLossEvent;
import br.com.twinsflammer.factionsprivateer.mcmmo.events.hardcore.McMMOPlayerVampirismEvent;
import br.com.twinsflammer.factionsprivateer.mcmmo.events.party.McMMOPartyLevelUpEvent;
import br.com.twinsflammer.factionsprivateer.mcmmo.events.party.McMMOPartyTeleportEvent;
import br.com.twinsflammer.factionsprivateer.mcmmo.events.party.McMMOPartyXpGainEvent;
import br.com.twinsflammer.factionsprivateer.mcmmo.events.skills.abilities.McMMOPlayerAbilityActivateEvent;
import br.com.twinsflammer.factionsprivateer.mcmmo.events.skills.abilities.McMMOPlayerAbilityDeactivateEvent;
import br.com.twinsflammer.factionsprivateer.mcmmo.events.skills.fishing.McMMOPlayerFishingTreasureEvent;
import br.com.twinsflammer.factionsprivateer.mcmmo.events.skills.fishing.McMMOPlayerMagicHunterEvent;
import br.com.twinsflammer.factionsprivateer.mcmmo.events.skills.repair.McMMOPlayerRepairCheckEvent;
...
public class EventUtils {
    ...
    public static boolean handleVampirismEvent(Player killer, Player victim, HashMap<String, Integer> levelChanged, HashMap<String, Float> experienceChanged) {
        ...
        FactionsPrivateer.getInstance().getServer().getPluginManager().callEvent(eventKiller);
        FactionsPrivateer.getInstance().getServer().getPluginManager().callEvent(eventVictim);
