...
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.chat.AdminChatCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.chat.PartyChatCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.database.McpurgeCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.database.McremoveCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.database.MmoshowdbCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.experience.AddlevelsCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.experience.AddxpCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.experience.MmoeditCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.experience.SkillresetCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.hardcore.HardcoreCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.hardcore.VampirismCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.party.PartyCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.party.teleport.PtpCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.config.Config;
import br.com.twinsflammer.factionsprivateer.mcmmo.locale.LocaleLoader;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.KrakenCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.McImportCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.McabilityCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.McconvertCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.McgodCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.McmmoCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.McnotifyCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.McrefreshCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.MobhealthCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.XprateCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.player.InspectCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.player.MccooldownCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.player.McrankCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.player.McstatsCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.player.MctopCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.skills.AcrobaticsCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.skills.AlchemyCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.skills.ArcheryCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.skills.AxesCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.skills.ExcavationCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.skills.FishingCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.skills.HerbalismCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.skills.MiningCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.skills.RepairCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.skills.SalvageCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.skills.SmeltingCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.skills.SwordsCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.skills.TamingCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.skills.UnarmedCommand;
import br.com.twinsflammer.factionsprivateer.mcmmo.commands.skills.WoodcuttingCommand;
...
//        }
    ...
    private static void registerAddlevelsCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("addlevels");
    ...
    private static void registerAddxpCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("addxp");
    ...
    private static void registerMcgodCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mcgod");
    ...
    private static void registerMcrefreshCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mcrefresh");
    ...
    private static void registerMmoeditCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mmoedit");
    ...
    private static void registerSkillresetCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("skillreset");
    ...
    private static void registerXprateCommand() {
        ...
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("xprate");
    ...
    public static void registerInspectCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("inspect");
    ...
    private static void registerMccooldownCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mccooldown");
    ...
    private static void registerMcabilityCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mcability");
    ...
    private static void registerMcmmoCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mcmmo");
    ...
    private static void registerMcrankCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mcrank");
    ...
    public static void registerMcstatsCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mcstats");
    ...
    public static void registerMctopCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mctop");
    ...
    private static void registerMcpurgeCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mcpurge");
    ...
    private static void registerMcremoveCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mcremove");
    ...
    private static void registerMmoshowdbCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mmoshowdb");
    ...
    private static void registerMcconvertCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mcconvert");
    ...
    private static void registerAdminChatCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("adminchat");
    ...
    private static void registerPartyChatCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("partychat");
    ...
    private static void registerPartyCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("party");
    ...
    private static void registerPtpCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("ptp");
    ...
    private static void registerHardcoreCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("hardcore");
    ...
    private static void registerVampirismCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("vampirism");
    ...
    private static void registerMcnotifyCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mcnotify");
    ...
    private static void registerMobhealthCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mobhealth");
...
//    }
    private static void registerKrakenCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("kraken");
    ...
    private static void registerMcImportCommand() {
        PluginCommand command = FactionsPrivateer.getInstance().getCommand("mcimport");
