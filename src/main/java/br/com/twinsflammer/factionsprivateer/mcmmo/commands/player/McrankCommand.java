...
import br.com.twinsflammer.factionsprivateer.mcmmo.runnables.commands.McrankCommandAsyncTask;
    ...
    private void display(CommandSender sender, String playerName) {
        if (sender instanceof Player) {
            ...
            if (((Player) sender).hasMetadata(mcMMO.databaseCommandKey)) {
                ...
                ((Player) sender).setMetadata(mcMMO.databaseCommandKey, new FixedMetadataValue(FactionsPrivateer.getInstance(), null));
            }
        ...
        new McrankCommandAsyncTask(playerName, sender, useBoard, useChat).runTaskAsynchronously(FactionsPrivateer.getInstance());
    }
}
