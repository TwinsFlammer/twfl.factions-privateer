package br.com.twinsflammer.factionsprivateer.mcmmo.datatypes.player;
...
import br.com.twinsflammer.factionsprivateer.mcmmo.runnables.skills.AbilityDisableTask;
import br.com.twinsflammer.factionsprivateer.mcmmo.runnables.skills.BleedTimerTask;
import br.com.twinsflammer.factionsprivateer.mcmmo.runnables.skills.ToolLowerTask;
...
import br.com.twinsflammer.factionsprivateer.mcmmo.skills.alchemy.AlchemyManager;
...
public class McMMOPlayer {
    ...
    public McMMOPlayer(Player player, PlayerProfile profile) {
        ...
        this.player = player;
        playerMetadata = new FixedMetadataValue(FactionsPrivateer.getInstance(), playerName);
        ...
        try {
            ...
            e.printStackTrace();
            FactionsPrivateer.getInstance().getPluginLoader().disablePlugin(FactionsPrivateer.getInstance());
        }
    ...
    public void checkAbilityActivation(SkillType skill) {
        ...
        new AbilityDisableTask(this, ability).runTaskLater(FactionsPrivateer.getInstance(), ticks * Misc.TICK_CONVERSION_FACTOR);
    }
    ...
    public void processAbilityActivation(SkillType skill) {
        ...
        if (ability.getPermissions(player) && tool.inHand(inHand) && !getToolPreparationMode(tool)) {
            ...
            new ToolLowerTask(this, tool).runTaskLaterAsynchronously(FactionsPrivateer.getInstance(), 4 * Misc.TICK_CONVERSION_FACTOR);
        }
    }
