...
public final class SQLDatabaseManager implements DatabaseManager {
    ...
    public void purgePowerlessUsers() {
        massUpdateLock.lock();
        FactionsPrivateer.getInstance().getLogger().info("Purging powerless users...");
        ...
        FactionsPrivateer.getInstance().getLogger().info("Purged " + purged + " users from the database.");
    }

    public void purgeOldUsers() {
        massUpdateLock.lock();
        FactionsPrivateer.getInstance().getLogger().info("Purging inactive users older than " + (PURGE_TIME / 2630000000L) + " months...");
    ...
    public boolean saveUser(PlayerProfile profile) {
        ...
        try {
            ...
            if (id == -1) {
                id = newUser(connection, profile.getPlayerName(), profile.getUniqueId());
                if (id == -1) {
                    FactionsPrivateer.getInstance().getLogger().severe("Failed to create new account for " + profile.getPlayerName());
                    return false;
                }
            }
            ...
            statement.close();
            if (!success) {
                FactionsPrivateer.getInstance().getLogger().severe("Failed to update last login for " + profile.getPlayerName());
                return false;
            }
            ...
            statement.close();
            if (!success) {
                FactionsPrivateer.getInstance().getLogger().severe("Failed to update skills for " + profile.getPlayerName());
                return false;
            }
            ...
            statement.close();
            if (!success) {
                FactionsPrivateer.getInstance().getLogger().severe("Failed to update experience for " + profile.getPlayerName());
                return false;
            }
            ...
            statement.close();
            if (!success) {
                FactionsPrivateer.getInstance().getLogger().severe("Failed to update cooldowns for " + profile.getPlayerName());
                return false;
            }
            ...
            statement.close();
            if (!success) {
                FactionsPrivateer.getInstance().getLogger().severe("Failed to update hud settings for " + profile.getPlayerName());
                return false;
            }
        } catch (SQLException ex) {
            printErrors(ex);
    ...
    private int newUser(Connection connection, String playerName, UUID uuid) {
        ...
        try {
            ...
            if (!resultSet.next()) {
                FactionsPrivateer.getInstance().getLogger().severe("Unable to create new user account in DB");
                return -1;
            }
    ...
    private void checkStructure() {
        ...
        try {
            ...
            FactionsPrivateer.getInstance().getLogger().info("Killing orphans");
            createStatement = connection.createStatement();
    ...
    private void printErrors(SQLException ex) {
        ...
        FactionsPrivateer.getInstance().getLogger().severe("Location: " + element.getClassName() + " " + element.getMethodName() + " " + element.getLineNumber());
        FactionsPrivateer.getInstance().getLogger().severe("SQLException: " + ex.getMessage());
        FactionsPrivateer.getInstance().getLogger().severe("SQLState: " + ex.getSQLState());
        FactionsPrivateer.getInstance().getLogger().severe("VendorError: " + ex.getErrorCode());
    }
    ...
    private void checkNameUniqueness(final Statement statement) throws SQLException {
        ...
        try {
            ...
            resultSet.close();
            FactionsPrivateer.getInstance().getLogger().info("Updating mcMMO MySQL tables to drop name uniqueness...");
    ...
    private void checkUpgradeAddAlchemy(final Statement statement) throws SQLException {
        try {
            ...
            FactionsPrivateer.getInstance().getLogger().info("Updating mcMMO MySQL tables for Alchemy...");
    ...
    private void checkUpgradeAddBlastMiningCooldown(final Statement statement) throws SQLException {
        try {
            ...
            FactionsPrivateer.getInstance().getLogger().info("Updating mcMMO MySQL tables for Blast Mining...");
    ...
    private void checkUpgradeAddFishing(final Statement statement) throws SQLException {
        try {
            ...
            FactionsPrivateer.getInstance().getLogger().info("Updating mcMMO MySQL tables for Fishing...");
    ...
    private void checkUpgradeAddMobHealthbars(final Statement statement) throws SQLException {
        try {
            ...
            FactionsPrivateer.getInstance().getLogger().info("Updating mcMMO MySQL tables for mob healthbars...");
    ...
    private void checkUpgradeAddScoreboardTips(final Statement statement) throws SQLException {
        try {
            ...
            FactionsPrivateer.getInstance().getLogger().info("Updating mcMMO MySQL tables for scoreboard tips...");
    ...
    private void checkUpgradeAddSQLIndexes(final Statement statement) throws SQLException {
        ...
        try {
            ...
            if (resultSet.getRow() != SkillType.NON_CHILD_SKILLS().size()) {
                FactionsPrivateer.getInstance().getLogger().info("Indexing tables, this may take a while on larger databases");
    ...
    private void checkUpgradeAddUUIDs(final Statement statement) {
        ...
        try {
            ...
            if (!column_exists) {
                FactionsPrivateer.getInstance().getLogger().info("Adding UUIDs to mcMMO MySQL user table...");
        ...
        new GetUUIDUpdatesRequired().runTaskLaterAsynchronously(FactionsPrivateer.getInstance(), 100); // wait until after first purge
    }
    ...
    private void checkUpgradeDropPartyNames(final Statement statement) {
        ...
        try {
            ...
            if (column_exists) {
                FactionsPrivateer.getInstance().getLogger().info("Removing party name from users table...");
    ...
    private void checkUpgradeDropSpout(final Statement statement) {
        ...
        try {
            ...
            if (column_exists) {
                FactionsPrivateer.getInstance().getLogger().info("Removing Spout HUD type from huds table...");
