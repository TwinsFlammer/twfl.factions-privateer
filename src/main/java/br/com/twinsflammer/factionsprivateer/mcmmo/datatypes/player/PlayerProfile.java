...
import br.com.twinsflammer.factionsprivateer.mcmmo.datatypes.experience.SkillXpGain;
...
public class PlayerProfile {
    ...
    public void scheduleAsyncSave() {
        new PlayerProfileSaveTask(this).runTaskAsynchronously(FactionsPrivateer.getInstance());
    }
    ...
    public void save() {
        ...
        if (changed) {
            FactionsPrivateer.getInstance().getLogger().warning("PlayerProfile saving failed for player: " + playerName + " " + uuid);
        }
    }
