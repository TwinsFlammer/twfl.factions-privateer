        ...
        switch (args.length) {
            case 1:
                ...
                if (mcMMO.p.isXPEventEnabled()) {
                    FactionsPrivateer.getInstance().getServer().broadcastMessage(LocaleLoader.getString("Commands.xprate.over"));
            ...
            case 2:
                ...
                if (mcMMO.p.isXPEventEnabled()) {
                    FactionsPrivateer.getInstance().getServer().broadcastMessage(LocaleLoader.getString("Commands.xprate.started.0"));
                    FactionsPrivateer.getInstance().getServer().broadcastMessage(LocaleLoader.getString("Commands.xprate.started.1", newXpRate));
                } else {
